...
export class AppComponent {
  ...
  worldMusicList = [  
    ...
    { name: "Blues Music Vault - TOMORROW AIN'T PROMISED ", link: ['/TomorrowAINTPromised', 'Dicg66K2p4Y'],},
    { name: 'Morgan Luna  - Fear in the Air', link: ['/FearInTheAir', 'HjCGX9Ma_eg'] }, 
    { name: 'EddieRiverz  - Feeling Good Today', link: ['/FeelingGoodToday', 'gvGH8Cfi9k8'] }, 
    { name: 'Jaxson Blue - Built to Last', link: ['/BuiltToLast', 'RVkZBose6ro'] },
    { name: 'JOHN DAVIS  - WHEN A MAN LOVES A WOMAN', link: ['/WhenAManLOVES', 'vBVNWRvy5zo'] }, 
    { name: 'Blues Music Vault - TOO OLD TO PRETEND', link: ['/TooHoldToPretend', '4k9iuJHFl2I'] }, 
    { name: 'T & L - HOLD ME IN YOUR QUIET HEART', link: ['/HoldMeInYOUR', 'H9s1AM6vkNg'] }, 
    ...
    { name: 'Jaxson Blue - Take a Little', link: ['/TakeALittle', 'iz0EWHMes8g'] },  
    { name: 'Etta Sale -   I chose myself', link:['/IchoseMyself' , 'f9l8kBwvRtA']},
    { name: 'JOHN DAVIS  - Where is that Man', link: ['/IWhereIsThatMan', 'ykc1_5Tq8LA'] }, 
