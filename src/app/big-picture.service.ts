...
export class BigPictureService {
  ...
  private bigPictures: BigPicture[] = [
    ...
    { name: 'Rémy Miantezila', role: 'Conseiller , Webmaster ; ', location: 'États-Unis', imageUrl: 'assets/images/dirigeants/RemyWithbackGroud.jpg', gender: 1, defaultImage: 'assets/images/dirigeants/RemyWithbackGroud.jpg', profession: 'Software Engineer', message: 'Sending love to all of you!', LinkedIn: 'https://www.linkedin.com/in/remy-miantezila-miabwa/' },
